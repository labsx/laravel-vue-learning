...
const editUserSchema = yup.object({
    name: yup.string().required(),
    email: yup.string().email().required(),
    // password: yup.string().notRequired().test('password','Password must be minimum of 8 characters',
    // function(value){
    //     if(!!value){
...
const deleteUser = () => {
    ...
    .then(() => {
        ...
        toastr.success('user Data successully deleted');
    });
};
